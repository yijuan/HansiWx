...
<body>
    <div class="contain">
        ...
        <%--<div class="navbar navbar-fixed-top">
             ...
             <span class="tex">上海悍思咨询与管理有限公司</span>
             <span class="gly"><img src="${resource(dir:'images',file:'home.png')}" style=" width: 8%; height: 55%; margin-left:10%;"/></span>
        </div>
              ...
              <div id="myCarousel" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner" role="listbox">
				      <div class="item active">
				        <img src="${resource(dir:'images',file:'bigDate.png')}" alt="Chania" style="width:100%; height:196px">  
				      </div>
				      <div class="item">
				        <img src="${resource(dir:'images',file:'background.jpg')}" alt="Flower" style="width:100%; height:196px">       
				      </div>
                   </div>
                 </div>
        </div>
        ...
        <div class="middle">
           <div class="middle_top">
              ...
              <a href="${createLink(action:'productIntro',controller:'hanSi')}"><div class="top_right"><img src="${resource(dir:'images',file:'int1.png')}" class="img1"/><br><span class="te">产品介绍</span></div></a>
           </div>
           
           <div class="middle_m">
              <div class="m_left">
                  <img src="${resource(dir:'images',file:'7.jpg')}" style="width: 100%; height: 100%;"/>
              </div>
              <div class="m_left1">
                  <div class="m_l_t" style="background-color: #000;">
                     <img src="${resource(dir:'images',file:'9.jpg')}" style="width: 100%; height: 93%;"/>
                  </div>
                  <div class="m_l_b">
                      <a href="${createLink(action:'business',controller:'hanSi')}"> <span style=" margin-left:25%; margin-top:30%; font-weight:bold;">商业合作</span><img src="${resource(dir:'images',file:'ing.png')}" style="width:20%; height: 30%;"/></a>
                  </div>
              </div>
           </div>
            ...
            <div class="middle_b">
              <div class="b_left">
                  <div class="b_l_t">
                     ...
                     <a href="${createLink(action:'join',controller:'hanSi')}"><div class="b2"><img src="${resource(dir:'images',file:'76.png')}" class="img2"/><br><span class="te1">加入我们</span></div></a>
                  </div>
        ...
        <%--<div class="navbar navbar-fixed-bottom">
             <div class="btl">
	          <a class="prev"><img src="${resource(dir:'images',file:'aar.png') }" style="width:50%; height:60%; margin-top:15px;"/></a>
	        </div> 
            
            <ul class="clear">               
                <li><div class="p1">
	               <div style="margin-top:10px;">
		             <img src="${resource(dir:'images',file:'about1.png')}" class="im"/>
		          </div>
                ...
                <li><div class="p1">
	               <div style="margin-top:10px;">
		             <img src="${resource(dir:'images',file:'busi1.png')}" class="im"/>
		          </div>
		          <div style="margin-top:-15px;">
                ...
                <li><div class="p2">
	               <div style="margin-top:10px;">
		             <img src="${resource(dir:'images',file:'int11.png')}" class="im"/>
		          </div>
		          <div style="margin-top:-15px;">
                ...
                <li><div class="p1">
	               <div style="margin-top:10px;">
		             <img src="${resource(dir:'images',file:'cus.png')}" class="im"/>
		          </div>
		          <div style="margin-top:-15px;">
                ...
                <li><div class="p2">
		          ...
		          <div style="margin-top:-15px;">
		            <span class="t">加入我们</span>
		          </div>
	           </div></li>
            </ul>
            
            <div class="btr">
	          <a class="next"><img src="${resource(dir:'images',file:'aar2.png') }" style="width:50%; height:60%; margin-top:5px;"/></a>
	        </div> 
