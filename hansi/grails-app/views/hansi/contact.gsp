...
<div>
	...
	<div>
		...
		<g:form action="traffic" controllers="hansi" method="">
			<p align="center"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> &nbsp;<b style="font-size:18px; color:#9b6c2b;">留言建议</b></p>		
			<p><input type="text" maxlength="20" name="name" placeholder="请输入你的名字 (Place enter your name)"/></p>
			<p><input type="text" maxlength="20" name="E-mail" placeholder="请输入你的邮箱 (Place enter your E-mail)"/></p>
			<p><textarea placeholder="请输入你的留言 (Place enter your message)" style="width:300px; height:80px; border:1px solid #a7a7a7;"></textarea></p>
			<p><input type="submit" value="提交留言" style="border:0px; font-size:22px; background-color:#fda520; width:120px; height:36px; color:#fff; font-weight:bold;"></p>
		</g:form>
