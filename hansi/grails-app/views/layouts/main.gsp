...
.navbar{ background-color: #1E1E1E; height:50px; text-align: center; line-height: 60px;}
...
<div class="navbar navbar-fixed-bottom">
	<div class="btl">
		...
		<a href="${createLink(action:'productIntro',controller:'hanSi')}"> 
			<div class="p2">
			<div>
				<img src="${resource(dir:'images',file:'int11.png')}" style="width: 40%; height: 30%;"/>
			</div>
			<div style="margin-top:-5px;">
		...
		<a href="${createLink(action:'business',controller:'hanSi')}"> 
			<div class="p1">
			<div>
				<img src="${resource(dir:'images',file:'ingg.png')}" style="width: 40%; height: 30%;"/>
			</div>
			<div style="margin-top:-5px;">
